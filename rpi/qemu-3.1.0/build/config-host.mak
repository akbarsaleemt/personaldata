...
libs_softmmu=-lpixman-1 -lutil -lnuma -lbluetooth -lpng12 -ljpeg  -lfdt
GIT=git
GIT_SUBMODULES=
GIT_UPDATE=no
ARCH=x86_64
...
VERSION=3.1.0
PKGVERSION=
SRC_PATH=/home/takkaakb/akbar/rpi/qemu-3.1.0
...
QEMU_INCLUDES=-iquote $(SRC_PATH)/tcg -iquote $(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/takkaakb/akbar/rpi/qemu-3.1.0/build/linux-headers -iquote . -iquote $(SRC_PATH) -iquote $(SRC_PATH)/accel/tcg -iquote $(SRC_PATH)/include
AUTOCONF_HOST := 
